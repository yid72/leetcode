...
public class Q00297_SerializeAndDeserializeBinaryTree {
    ...
    public static void main(String[] args) {
        ...
        Q00297_SerializeAndDeserializeBinaryTree q = new Q00297_SerializeAndDeserializeBinaryTree();
        String output = q.serialize(root);
        System.out.println(output);

        TreeUtil.printTree(q.deserialize(output));
    }
}
